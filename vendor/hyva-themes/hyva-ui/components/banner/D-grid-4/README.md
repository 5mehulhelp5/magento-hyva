...
1. Copy or merge the following files/folders into your theme:
   * `Magento_Cms/templates/elements/banner-d.phtml`
2. Adjust the content and code to fit your own needs and save
3. Create your development or production bundle by running `npm run watch` or `npm run build-prod` in your
   theme's tailwind directory

> There's an example how to insert the `banner-d.phtml` into your homepage in `Magento_Cms/layout/cms_index_index.xml`
...
[preview-1]: ./media/D-grid-4.jpg "Preview of Banner D on Desktop view"
[preview-2]: ./media/D-grid-4-mobile.jpg "Preview of Banner D on Mobile view"
