...
class Interceptor extends \Magento\Directory\Block\Currency implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCurrencyCount');
        return $pluginInfo ? $this->___callPlugins('getCurrencyCount', func_get_args(), $pluginInfo) : parent::getCurrencyCount();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCurrencies');
        return $pluginInfo ? $this->___callPlugins('getCurrencies', func_get_args(), $pluginInfo) : parent::getCurrencies();
    }
    ...
    public function getSwitchCurrencyPostData($code)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getSwitchCurrencyPostData', func_get_args(), $pluginInfo) : parent::getSwitchCurrencyPostData($code);
    }
