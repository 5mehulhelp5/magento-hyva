...
class Interceptor extends \Magento\Catalog\Block\Product\View\Options implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getGroupOfOption');
        return $pluginInfo ? $this->___callPlugins('getGroupOfOption', func_get_args(), $pluginInfo) : parent::getGroupOfOption($type);
    }
