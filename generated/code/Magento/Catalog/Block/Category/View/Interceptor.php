...
class Interceptor extends \Magento\Catalog\Block\Category\View implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCmsBlockHtml');
        return $pluginInfo ? $this->___callPlugins('getCmsBlockHtml', func_get_args(), $pluginInfo) : parent::getCmsBlockHtml();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isProductMode');
        return $pluginInfo ? $this->___callPlugins('isProductMode', func_get_args(), $pluginInfo) : parent::isProductMode();
    }
