...
class Interceptor extends \Magento\Catalog\Block\Breadcrumbs implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTitleSeparator');
        return $pluginInfo ? $this->___callPlugins('getTitleSeparator', func_get_args(), $pluginInfo) : parent::getTitleSeparator($store);
    }
