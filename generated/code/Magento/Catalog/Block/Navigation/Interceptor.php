...
class Interceptor extends \Magento\Catalog\Block\Navigation implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCurrentCategoryKey');
        return $pluginInfo ? $this->___callPlugins('getCurrentCategoryKey', func_get_args(), $pluginInfo) : parent::getCurrentCategoryKey();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCurrentChildCategories');
        return $pluginInfo ? $this->___callPlugins('getCurrentChildCategories', func_get_args(), $pluginInfo) : parent::getCurrentChildCategories();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isCategoryActive');
        return $pluginInfo ? $this->___callPlugins('isCategoryActive', func_get_args(), $pluginInfo) : parent::isCategoryActive($category);
    }
