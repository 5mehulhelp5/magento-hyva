...
class Interceptor extends \Magento\PaymentServicesPaypal\Block\SmartButtonsProduct implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getComponentParams');
        return $pluginInfo ? $this->___callPlugins('getComponentParams', func_get_args(), $pluginInfo) : parent::getComponentParams();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isLocationEnabled');
        return $pluginInfo ? $this->___callPlugins('isLocationEnabled', func_get_args(), $pluginInfo) : parent::isLocationEnabled($location);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isApplePayLocationEnabled');
        return $pluginInfo ? $this->___callPlugins('isApplePayLocationEnabled', func_get_args(), $pluginInfo) : parent::isApplePayLocationEnabled($location);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isGooglePayLocationEnabled');
        return $pluginInfo ? $this->___callPlugins('isGooglePayLocationEnabled', func_get_args(), $pluginInfo) : parent::isGooglePayLocationEnabled($location);
    }
